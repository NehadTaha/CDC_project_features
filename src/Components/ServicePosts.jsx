            ...
            (!filterMunicipality ||
              ...
              /(?:<span class="field-content"><strong>|\b)([\d\s-]+)(?:<\/strong><\/span>|$)/;
                ...
                localStorage.setItem(
                    "servicePosts",
                    JSON.stringify(filteredServicePosts)
                );
            } catch (error) {
                console.error("Error fetching data:", error);
                let servicePosts = localStorage.getItem("servicePosts");
                servicePosts = JSON.parse(servicePosts);
                setServicePosts(servicePosts);
            }
        };
                ...
                <div key={post.id}>
                  ...
                  Voir ce Service
                            ...
                            <div className="col-12 col-md-4 col-sm-6">
                                <ShareButton
                                    title={post.title}
                                    serviceLink={`https://cdcmemphremagog.com/?p=${post.id}`}
                                    id={post.id}
                                />
                            </div>
                        </div>
